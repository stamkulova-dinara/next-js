...
import BtnSlider from "../components/arrow-btn";
import '../styles/'
...
export default function Home({ news, categories, carouselSlide }) {
  ...
  const nextSlide = () => {
      if(slideIndex !== carouselSlide.images.length){
  ...
  const prevSlide = () => {
      if(slideIndex !== 1){
          ...
          setSlideIndex(carouselSlide.images.length)
      }
    ...
    <div className={styles.container}>
      ...
      <div>
        ...
        <div className="container-slider">
            {carouselSlide.images.map((obj, index) => {
                return (
                    <div
