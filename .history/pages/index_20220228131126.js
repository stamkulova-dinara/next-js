...
import InterestingNewSlider from "../components/interesting-slider";
...
export async function getServerSideProps() {
  const respon = await fetch('http://api.kabar-media.kg/api/v1/categories/')
  const json = await respon.json()
...
export default function Home({ news, cate }) {
