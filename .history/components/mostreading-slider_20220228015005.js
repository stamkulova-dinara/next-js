    ...
    <div style={{ margin: 30 }}>
      ...
      >
        {res.map((el) => (
             ...
             <CardActionArea>
                 {el.media == null ? (
                     <img src={el.images[0].image} className={styles.images}/>
             ...
             <CardContent className={styles.card_contents}>
               <Typography gutterBottom variant="h6" component="h3">
                 {el.region}
               </Typography>
               <Typography variant="body2" component="p" className={styles.titles}>
                {el.title}
               </Typography>
             </CardContent>
           </CardActionArea>
             <CardActions className={styles.card_action}>
               ...
               <div className={styles.cvs}>
                 ...
                 <div id={styles.views}>{el.viewed}</div>
                 </div>
                 <div className={styles.shares}><Image className={styles.imgs} src={share}/></div>
               </CardActions>  
