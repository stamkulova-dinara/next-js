...
const Sliders = () => {
    ...
    const regionOshData = async () => {
      const respon = await fetch('http://api.kabar-media.kg/api/v1/articles/most-viewed/?region=Osh')
      const data = await respon.ls
      console.log(respon)
    }
  ...
  return (
    ...
    <div style={{marginTop: '50px'}}>
      ...
      <div>
        <button className={styles.btn} onClick={regionOshData}>Ош</button>
